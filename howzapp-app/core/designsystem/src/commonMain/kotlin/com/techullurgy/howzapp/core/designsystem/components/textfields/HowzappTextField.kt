package com.techullurgy.howzapp.core.designsystem.components.textfields
...
fun HowzappTextFieldEmptyPreview() {
    HowzAppTheme {
        HowzappTextField(
...
fun HowzappTextFieldFilledPreview() {
    HowzAppTheme {
        HowzappTextField(
            state = rememberTextFieldState(
...
fun HowzappTextFieldDisabledPreview() {
    HowzAppTheme {
        HowzappTextField(
            state = rememberTextFieldState(),
            modifier = Modifier
...
fun HowzappTextFieldErrorPreview() {
    HowzAppTheme {
        HowzappTextField(
            state = rememberTextFieldState(),
            modifier = Modifier
