package com.techullurgy.howzapp.core.designsystem.components.layouts
...
import com.techullurgy.howzapp.core.designsystem.components.brand.HowzappSuccessIcon
...
@Composable
@Preview
fun HowzappSimpleSuccessLayoutPreview() {
    HowzAppTheme(darkTheme = true) {
        HowzappSimpleResultLayout(
            title = "Hello world!",
